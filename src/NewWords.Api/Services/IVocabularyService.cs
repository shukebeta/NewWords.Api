...
namespace NewWords.Api.Services
{
    ...
    public interface IVocabularyService
    {
        ...
        Task<UserWordDto?> AddWordAsync(int userId, AddWordRequestDto addWordDto);
        ...
        Task<List<UserWordDto>> GetUserWordsAsync(int userId, WordStatus? status, int page, int pageSize);
        ...
        Task<UserWordDto?> GetUserWordDetailsAsync(int userId, int userWordId);
        ...
        Task<bool> UpdateWordStatusAsync(int userId, int userWordId, WordStatus newStatus);
