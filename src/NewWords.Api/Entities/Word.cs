...
namespace NewWords.Api.Entities
{
    ...
    [SugarIndex("UQ_Words_Text_Lang_NativeLang", nameof(WordText), OrderByType.Asc, nameof(WordLanguage), OrderByType.Asc, nameof(UserNativeLanguage), OrderByType.Asc, true)]
    public class Word
    {
        /// <summary>
